...
export default function Navbar() {
  ...
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div className="flex items-center justify-between h-20"> {/* Navbar height increased to h-20 */}
      <div className="flex items-center">
        
        {/* Logo Section with doubled size */}
        <img
          src="src/Assets/Nexa_Vision_Logo-removebg-preview.png" // Replace with your logo image path
